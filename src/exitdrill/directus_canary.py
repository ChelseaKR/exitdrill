...
def _exact_keys(
    ...
    name in `tests/test_directus_canary.py`, so adopting the shared wording
    would change what this canary tells an operator, not just where the code
    lives. `civicrm_target_canary._exact_keys` carries the same check verbatim.
    """
