...
def _assert_clean_contact_summary_workflow_result(document: Mapping[str, object]) -> None:
    _require(
        document
        == {
            ...
            "schema_version": "exitdrill/civicrm-contact-summary-workflow-result/v0.1",
            "target_profile": TARGET_PROFILE,
            "workflow_results": [
                {
                    "evidence_kind": "isolated_headless_chromium_read_only_interaction",
                    "id": "case_dashboard_to_contact_summary",
                    "state": "observed",
                }
            ],
        },
        "clean contact-summary workflow result was not exact",
    )
...
def _assert_clean_browser_access_denial_result(document: Mapping[str, object]) -> None:
    _require(
        document
        == {
            ...
            "denial_results": [
                {
                    ...
                    "id": "protected_contact_access_denial",
                    "state": "observed",
                }
            ],
            "known_runtime_errors": [
            ...
            "schema_version": "exitdrill/civicrm-browser-access-denial-result/v0.1",
            "target_profile": TARGET_PROFILE,
        },
        "clean browser access-denial result was not exact",
    )
...
def main() -> None:
    with tempfile.TemporaryDirectory(prefix="exitdrill-civicrm-target-") as raw_temp:
        ...
        clean_contact_summary_workflow_result = _json_object(
        ...
        clean_browser_access_denial_result = _json_object(
